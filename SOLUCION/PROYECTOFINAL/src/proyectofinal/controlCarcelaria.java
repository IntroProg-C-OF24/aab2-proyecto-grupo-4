...
public class controlCarcelaria {
                ...
                case 2:
                    ...
                    switch(opcion){
                        case 1:
                            ...
                            abrirArchivoCompleto(archivoPrincipal, principal, filas);
                            break;
                        case 2:
                        ...
                        if(contraseña.equals("12345")){
                            ...
                            switch(opcion){
                                ...
                                case 2:
                                    ...
                                    switch(opcion){
                                        case 1:
                                            ...
                                            cedula = tc.next();
                                            disminuirvisita(cedula, principal, filas, archivoPrincipal, pabellon1, pabellon2, pabellon3, pabellon4, pabellon5);
                                            break;
                                        case 2:
                                            System.out.println("Ingresa la identificacion del PPL");
                                            cedula = tc.next();
                                            aumentarpena(cedula, principal, filas, archivoPrincipal, pabellon1, pabellon2, pabellon3, pabellon4, pabellon5);
                                            break;
                                        default:
                                            System.out.println("Opcion Incorrecta");
                                    }
                                ...
                                case 3:
                                    ...
                                    cedula = tc.next();
                                    trasladarPPL(cedula, principal, filas, archivoPrincipal, pabellon1, pabellon2, pabellon3, pabellon4, pabellon5);
                                    break;
                                case 4:
                                    ingresarPPL(principal, filas, archivoPrincipal, cedula, pabellon1, pabellon2, pabellon3, pabellon4, pabellon5);
                                    break;
                                default:
                                    System.out.println("Opcion incorrecta");
                            }
    ...
    public static void abrirArchivoCompleto(String archivoPrincipal, String [][] principal, int filas) {
    ...
    //Administracion
    public static void trasladarPPL(String cedula, String[][] principal, int filas, String archivoPrincipal, String pabellon1, String pabellon2,String pabellon3,String pabellon4,String pabellon5){
        leercsv(principal, archivoPrincipal);
        for (int i = 1; i < filas; i++) {
            if(cedula.equals(principal[i][1])){
                principal[i][1] = "libre";
    ...
    public static void disminuirvisita(String cedula, String[][] principal, int filas, String archivoPrincipal, String pabellon1, String pabellon2,String pabellon3,String pabellon4,String pabellon5){
        Scanner tc = new Scanner(System.in);
    ...
    public static void aumentarpena(String cedula, String[][] principal, int filas, String archivoPrincipal, String pabellon1, String pabellon2,String pabellon3,String pabellon4,String pabellon5){
        leercsv(principal, archivoPrincipal);
        Scanner tc = new Scanner(System.in);
        int aumento = 0;
        for (int i = 1; i < filas; i++) {
    ...
    public static void ingresarPPL(String[][] principal, int filas, String archivoPrincipal, String cedula, String pabellon1, String pabellon2,String pabellon3,String pabellon4,String pabellon5){
        Scanner tc = new Scanner(System.in);
        int cupo = 0;
        for (int i = 1; i < filas; i++) {
